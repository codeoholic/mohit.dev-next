...
export const Text = ( props ) => {
    ...
    return (
        <p className="text-lg text-zinc-800 dark:text-zinc-300 pt-2.5">{ props.children }</p>
    )
...
export const OrderedListItem = ( props ) => {
    ...
    return (
        <li className="text-lg text-zinc-800 dark:text-zinc-300 pt-2.5">{ props.children }</li>
    )
...
export const Anchor = ( props ) => {
    ...
    return (
        <a className="underline text-lg text-zinc-800 dark:text-zinc-300 cursor-pointer">{ props.children }</a>
    )
